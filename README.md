...
🖥️ Process Management in Python This project demonstrates key Operating System process management concepts using Python, including process creation, execution, zombies & orphans, process inspection, and scheduling with priorities.

📌 Tasks Overview Task 1: Process Creation Utility
...
ps -el | grep defunct Task 4: Inspecting Process Info from /proc
